...
export const SocketProvider: React.FC<Props> = ({ children }) => {
    ...
    const removeUserFeed = () => {
        ...
        setStream(null); // Set stream to null or a new stream without video
    }
    ...
    return (
        <SocketContext.Provider value={{ socket, user, stream, peers,fetchUserFeed,removeUserFeed }}>
            {children}
